...
[Install a Harness Delegate or a dedicated chaos infrastructure](../../infrastructure/types) before creating a condition because a condition is applied to an infrastructure.
