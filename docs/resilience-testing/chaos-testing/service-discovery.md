...
:::tip
You can leverage all the [permissions mentioned](/docs/resilience-testing/security/security-templates/openshift-scc#run-service-account-as-a-cluster-admin) for fault execution as well as service discovery.
:::
...
This ensures compatibility with GKE Autopilot's security restrictions. For complete GKE Autopilot setup including chaos engineering, see the [GKE Autopilot guide](./gke-autopilot).
:::
