...
1. [Set up a chaos experiment based on your application's requirements](../experiments): After saving the experiment, copy the experiment ID and choose a value for the `expected-resilience-score`.
