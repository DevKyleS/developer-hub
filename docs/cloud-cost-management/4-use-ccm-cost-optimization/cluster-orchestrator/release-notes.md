...
|---------|-------------|----------|
| <span style={{backgroundColor: '#28a745', color: 'white', padding: '2px 6px', borderRadius: '4px', fontSize: '0.8em', marginLeft: '8px'}}>LATEST</span>  `0.4.0` | Feb 3, 2026 | - Support for 0.8.0 build<br/>- New CRD `WorkloadDistributionRuleCheckpoint<br/>- New Deployment Distributor and its permissions<br/>- New component can be enabled via the value `clusterOrchestrator.distributor.enabled`<br/>- Adding `priorityClass` for Cluster Orchestrator components |
