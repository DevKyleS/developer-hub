...
* A **Harness pipeline** with active delegates and connectors. Please follow this [tutorial to get started with Harness Continuous Delivery (CD)](/docs/continuous-delivery/get-started/tutorials/kubernetes-container-deployments/manifest). The tutorial below uses the Harness resources created as part of that tutorial.
