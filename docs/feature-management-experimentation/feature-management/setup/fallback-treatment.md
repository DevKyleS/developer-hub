...
| Android | iOS | Browser | Flutter | JavaScript | React | React Native |  Java   | Python | Ruby | .NET   | Node.js   | Go    |
| ------- | ----- | ----- | ----- | ----- | ----- | ------ | ------ | ------ | ------- | ------ | ----- | ----- |
| 5.4.1+ | 3.4.0+ | 1.6.0+ | 1.2.0+ | 11.8.0+ | 2.6.0+ | 1.5.0+ | 4.18.0+ | 10.5.1+ | 8.9.0+ | 7.12.0+ | 11.8.0 + | 6.9.0+ | 
